...
const ASOEBI_WA = 'https://wa.me/2348140305453'
    ...
    <main className="min-h-screen bg-[#faf7f2] flex flex-col items-center relative overflow-hidden">
      ...
      <div className="w-full max-w-xs mx-auto px-5 pt-10 pb-20 text-center relative z-10">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2.5 w-full bg-[#25d366] hover:bg-[#1ebe5d] active:bg-[#1ebe5d] text-white rounded-lg py-3 mb-3 transition-colors duration-200 shadow-sm"
        >
          ...
          <span className="font-jost text-sm font-medium tracking-wide">Aso-ebi enquiries — WhatsApp us</span>
        </a>
